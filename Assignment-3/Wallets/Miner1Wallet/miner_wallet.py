...
def sendJSON(signed_transaction):
    if signed_transaction["content"].get("From") == "genesis_account":
        transaction={"id":"miner_transaction","signed_transaction":signed_transaction}
...
def main():
    if not os.path.exists(PRIVATE_KEY_PATH):
        ...
        print("Congratulations! You have created a new Miner Account")
        initial_balance=0
